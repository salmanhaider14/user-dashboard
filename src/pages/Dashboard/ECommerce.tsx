      ...
      <div className="grid md:grid-cols-3 grid-cols 1 gap-8">
        <div className="md:col-span-2  ">
          <div className="flex justify-between items-center flex-wrap ">
            <div className="w-[300px] h-[100px] bg-white rounded-md p-6 flex justify-center my-4">
        ...
        <div>
          <div className=" h-[100px] bg-white rounded-md p-6 flex justify-center my-4">
            <div className="flex items-center gap-2">
              {' '}
          ...
          <div className="bg-white p-4 mt-4">
            ...
            <div className="flex flex-col gap-3 my-5">
              <div className="flex items-center gap-2">
                ...
                <p className="w-[450.34px] text-main text-xs font-normal font-['Poppins'] leading-[18px]">
                  3 day ago
                </p>
              </div>
